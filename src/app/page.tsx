        ...
        <section className=\"relative overflow-hidden\">
          ...
          <div className=\"relative mx-auto flex max-w-5xl flex-col gap-6 px-4 py-16 md:py-20\">
            ...
            <p className=\"max-w-3xl text-lg leading-relaxed text-slate-200\">
              Korzion Global is an e-commerce trading company registered in Dubai Airport Free Zone (DAFZA). We import, store, and sell consumer electronics via Amazon, Noon, and Trendyol for customers across the GCC, Turkey, and selected EU markets.
            </p>
        ...
        <Section id=\"company\" title=\"Company overview\">
          <div className=\"grid gap-6 md:grid-cols-[1.2fr,1fr]\">
            <div className=\"leading-relaxed text-slate-200\">
              Korzion Global operates in Dubai Airport Free Zone with an e-commerce trading licence. Ownership is held by private shareholders, with an authorised manager in the UAE handling marketplace operations and compliance.
            </div>
          ...
          <div className=\"grid gap-6 md:grid-cols-[1.1fr,0.9fr]\">
            ...
            <Card title=\"Company details\">
              <div className=\"space-y-3 text-sm text-slate-200/90\">
                <div>
                  <p className=\"font-semibold text-slate-50\">Korzion Global</p>
                  <p>Dubai Airport Free Zone (DAFZA), Dubai, UAE</p>
                </div>
                <div>
                  <p>Phone: +971507785218</p>
